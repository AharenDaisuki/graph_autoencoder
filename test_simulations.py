...
class TestSumoSimulation(TestCase): 
    def test_sumo_parallel_simulation_handler(self): 
        # args 1
        matrix_dim = (10, 10, 20)
        ...
        detector_n = simulation_handler.get_link_n()
        print(f'{detector_n} detectors deployed')
        print('#' * 50 + '\n')
    ...
    def test_sumo_simulation_task(self):
        ...
        finish_code = sumo_simulation_task(matrix_dim, simulation_dataset, simulation_state, simulation_scenario, simulation_index, simulation_args, link_hash) 
        ...
        self.assertEqual(metadata['mu'].shape, (I, J, K))
        self.assertEqual(metadata['sigma'].shape, (I, J, K))
