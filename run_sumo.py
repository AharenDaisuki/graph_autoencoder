...
if __name__ == '__main__': 
    ...
    parser.add_argument('--period',     type = int, default = 180, help = 'measurement interval time')
    ...
    matrix_dim = (10, 10, 20)
    # configs
    simulation_handler = SumoParallelSimulationHandler(sumo_sim_args=args, simulation_dataset='sim_dataset_v2', matrix_dim=matrix_dim)
